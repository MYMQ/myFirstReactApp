  ...
  _createClass(TodoApp, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        null,
        _react2.default.createElement(_InputLine2.default, { onChange: this.handleChange, onClick: this.handleClick, input: this.state.userInput }),
        _react2.default.createElement(_TodoList2.default, { val: this.state.count, todoList: this.state.todoList, 'delete': function _delete(e) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('input', { onChange: function onChange(e) {
          ...
          }, type: 'text', name: 'todo', placeholder: 'thing to do', value: this.props.input }),
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: function onClick(e) {
              return _this2.props.delete(e, _this2.props.index);
            } },
          'D'
        )
      );
...
var TodoList = function (_React$Component) {
  ...
  _createClass(TodoList, [{
    ...
    value: function render() {
      ...
      return this.props.todoList.map(function (todo, index) {
        return _react2.default.createElement(_Todo2.default, { onClick: function onClick(e) {
            return _this2.handleClick(e);
          }, 'delete': function _delete(e) {
            return _this2.props.delete(e);
          }, index: index, key: todo.count.toString(), id: todo.count, todo: todo.input });
      });
    }
  }]);
